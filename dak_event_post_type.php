...
function dak_event_save_post_meta($post_id, $post) {
	...
	$dak_event_meta['dak_event_id'] = $_POST['dak_event_id'];
	$dak_event_meta['dak_event_url'] = $_POST['dak_event_url'];
	$dak_event_meta['dak_event_ical'] = $_POST['dak_event_ical'];
	$dak_event_meta['dak_event_linkout'] = $_POST['dak_event_linkout'];
	$dak_event_meta['dak_event_start_date'] = $_POST['dak_event_start_date'];
	$dak_event_meta['dak_event_start_time'] = $_POST['dak_event_start_time'];
	$dak_event_meta['dak_event_end_date'] = $_POST['dak_event_end_date'];
	$dak_event_meta['dak_event_end_time'] = $_POST['dak_event_end_time'];
	$dak_event_meta['dak_event_is_accepted'] = $_POST['dak_event_is_accepted'];
	$dak_event_meta['dak_event_is_public'] = $_POST['dak_event_is_public'];
	$dak_event_meta['dak_event_custom_location'] = $_POST['dak_event_custom_location'];
	$dak_event_meta['dak_event_common_location'] = $_POST['dak_event_common_location'];
	$dak_event_meta['dak_event_location_id'] = $_POST['dak_event_location_id'];
	$dak_event_meta['dak_event_arranger_id'] = $_POST['dak_event_arranger_id'];
	$dak_event_meta['dak_event_festival_id'] = $_POST['dak_event_festival_id'];
	$dak_event_meta['dak_event_primary_picture'] = $_POST['dak_event_primary_picture'];
	$dak_event_meta['dak_event_covercharge'] = $_POST['dak_event_covercharge'];
	$dak_event_meta['dak_event_age_limit'] = $_POST['dak_event_age_limit'];
	$dak_event_meta['dak_event_created_at'] = $_POST['dak_event_created_at'];
	$dak_event_meta['dak_event_updated_at'] = $_POST['dak_event_updated_at'];
	$dak_event_meta['dak_event_arranger'] = $_POST['dak_event_arranger'];
	$dak_event_meta['dak_event_categories'] = $_POST['dak_event_categories'];
	$dak_event_meta['dak_event_festival'] = $_POST['dak_event_festival'];
